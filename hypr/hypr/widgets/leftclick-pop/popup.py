...
#########################################################################################################
        ...
        self.media_buttons = CenterBox(
            orientation="h",
            start_children = Button(name='media_button',
                   style='padding:10px ; border-radius: 5px;',
                    child=Image(
                        name="apps",
                        image_file="/home/geronimo/.config/hypr/icon/previous.png",
                        size=38,
                    ),

                    on_clicked=lambda *_: exec_shell_command('playerctl previous'),
                ),
            center_children= Button(name='media_button',
                   style='padding:10px ; border-radius: 5px;',
                    child=Image(
                        name="apps",
                        image_file="/home/geronimo/.config/hypr/icon/play.png",
                        size=38,
                    ),

                    on_clicked=lambda *_: exec_shell_command('playerctl play-pause'),
                ),
            end_children= Button(name='media_button',
                   style='padding:10px ; border-radius: 5px;',
                    child=Image(
                        name="apps",
                        image_file="/home/geronimo/.config/hypr/icon/next.png",
                        size=38,
                    ),
